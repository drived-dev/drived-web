...
export interface Config {
  ...
  globalsSelect: {
    ...
    'side-nav': SideNavSelect<false> | SideNavSelect<true>;
  };
  locale: null;
  widgets: {
...
export interface Work {
  ...
  client: string;
  projectDate: string;
  heroImageSquare?: (number | null) | Media;
  heroImageWide?: (number | null) | Media;
  /**
   * If checked, this work will link to its case study page.
   */
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        'featured-works'?: T | FeaturedWorksBlockSelect<T>;
        'trust-marquee'?: T | TrustMarqueeBlockSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "side-nav_select".
 */
export interface SideNavSelect<T extends boolean = true> {
  navItems?:
    | T
    | {
        link?:
...
export interface ImageGalleryBlock {
  layout: 'single' | 'split' | 'columns' | 'carousel';
  images: {
    image: number | Media;
    id?: string | null;
  }[];
  aspectRatio?: ('square' | 'video' | 'portrait' | 'natural') | null;
  id?: string | null;
  blockName?: string | null;
