...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_featured_works\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_featured_works_order_idx\` ON \`pages_blocks_featured_works\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_featured_works_parent_id_idx\` ON \`pages_blocks_featured_works\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_featured_works_path_idx\` ON \`pages_blocks_featured_works\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_trust_marquee\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_marquee_order_idx\` ON \`pages_blocks_trust_marquee\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_marquee_parent_id_idx\` ON \`pages_blocks_trust_marquee\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_marquee_path_idx\` ON \`pages_blocks_trust_marquee\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_services_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_services_items_order_idx\` ON \`pages_blocks_services_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_services_items_parent_id_idx\` ON \`pages_blocks_services_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_services\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`section_label\` text DEFAULT 'Services',
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_blog_posts\` (
  	...
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`section_label\` text DEFAULT 'Latest Posts',
  ...
  await db.run(sql`CREATE INDEX \`pages_rels_works_id_idx\` ON \`pages_rels\` (\`works_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_featured_works\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_featured_works_order_idx\` ON \`_pages_v_blocks_featured_works\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_featured_works_parent_id_idx\` ON \`_pages_v_blocks_featured_works\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_featured_works_path_idx\` ON \`_pages_v_blocks_featured_works\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_trust_marquee\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_marquee_order_idx\` ON \`_pages_v_blocks_trust_marquee\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_marquee_parent_id_idx\` ON \`_pages_v_blocks_trust_marquee\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_marquee_path_idx\` ON \`_pages_v_blocks_trust_marquee\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_services_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`name\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_services_items_order_idx\` ON \`_pages_v_blocks_services_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_services_items_parent_id_idx\` ON \`_pages_v_blocks_services_items\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_rels_works_id_idx\` ON \`_pages_v_rels\` (\`works_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`works_populated_authors\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`works_populated_authors_order_idx\` ON \`works_populated_authors\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`works_populated_authors_parent_id_idx\` ON \`works_populated_authors\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`works\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text,
  	\`client\` text,
  	\`project_date\` text,
  	\`hero_image_square_id\` integer,
  	\`hero_image_wide_id\` integer,
  	\`has_case_study\` integer DEFAULT false,
  	\`hero_image_id\` integer,
  	\`content\` text,
  	\`meta_title\` text,
  	\`meta_image_id\` integer,
  	...
  	\`created_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	\`_status\` text DEFAULT 'draft',
  	FOREIGN KEY (\`hero_image_square_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`hero_image_wide_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`hero_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`meta_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`works_hero_image_square_idx\` ON \`works\` (\`hero_image_square_id\`);`)
  await db.run(sql`CREATE INDEX \`works_hero_image_wide_idx\` ON \`works\` (\`hero_image_wide_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`works_rels_works_id_idx\` ON \`works_rels\` (\`works_id\`);`)
  await db.run(sql`CREATE INDEX \`works_rels_categories_id_idx\` ON \`works_rels\` (\`categories_id\`);`)
  await db.run(sql`CREATE INDEX \`works_rels_users_id_idx\` ON \`works_rels\` (\`users_id\`);`)
  await db.run(sql`CREATE TABLE \`_works_v_version_populated_authors\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_uuid\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_works_v_version_populated_authors_order_idx\` ON \`_works_v_version_populated_authors\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_works_v_version_populated_authors_parent_id_idx\` ON \`_works_v_version_populated_authors\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_works_v\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`parent_id\` integer,
  	\`version_title\` text,
  	\`version_client\` text,
  	\`version_project_date\` text,
  	\`version_hero_image_square_id\` integer,
  	\`version_hero_image_wide_id\` integer,
  	\`version_has_case_study\` integer DEFAULT false,
  	\`version_hero_image_id\` integer,
  	\`version_content\` text,
  	\`version_meta_title\` text,
  	\`version_meta_image_id\` integer,
  	...
  	FOREIGN KEY (\`version_hero_image_square_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`version_hero_image_wide_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`version_hero_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`version_meta_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`_works_v_parent_idx\` ON \`_works_v\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_works_v_version_version_hero_image_square_idx\` ON \`_works_v\` (\`version_hero_image_square_id\`);`)
  await db.run(sql`CREATE INDEX \`_works_v_version_version_hero_image_wide_idx\` ON \`_works_v\` (\`version_hero_image_wide_id\`);`)
  await db.run(sql`CREATE INDEX \`_works_v_version_version_hero_image_idx\` ON \`_works_v\` (\`version_hero_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_works_v_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_works_v_rels_order_idx\` ON \`_works_v_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`_works_v_rels_parent_idx\` ON \`_works_v_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_works_v_rels_path_idx\` ON \`_works_v_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`_works_v_rels_works_id_idx\` ON \`_works_v_rels\` (\`works_id\`);`)
  await db.run(sql`CREATE INDEX \`_works_v_rels_categories_id_idx\` ON \`_works_v_rels\` (\`categories_id\`);`)
  await db.run(sql`CREATE INDEX \`_works_v_rels_users_id_idx\` ON \`_works_v_rels\` (\`users_id\`);`)
  ...
  `)
  await db.run(sql`CREATE TABLE \`side_nav_nav_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  	...
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`side_nav\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`side_nav_nav_items_order_idx\` ON \`side_nav_nav_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`side_nav_nav_items_parent_id_idx\` ON \`side_nav_nav_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`side_nav\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`updated_at\` text,
  	\`created_at\` text
  );
  `)
  await db.run(sql`CREATE TABLE \`side_nav_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  	\`pages_id\` integer,
  	\`posts_id\` integer,
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`side_nav\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`pages_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`posts_id\`) REFERENCES \`posts\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`side_nav_rels_order_idx\` ON \`side_nav_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`side_nav_rels_parent_idx\` ON \`side_nav_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`side_nav_rels_path_idx\` ON \`side_nav_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`side_nav_rels_pages_id_idx\` ON \`side_nav_rels\` (\`pages_id\`);`)
  await db.run(sql`CREATE INDEX \`side_nav_rels_posts_id_idx\` ON \`side_nav_rels\` (\`posts_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_featured_works\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_trust_marquee\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_services_items\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_featured_works\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_trust_marquee\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_services_items\`;`)
  ...
  await db.run(sql`DROP TABLE \`works_populated_authors\`;`)
  await db.run(sql`DROP TABLE \`works\`;`)
  await db.run(sql`DROP TABLE \`works_rels\`;`)
  await db.run(sql`DROP TABLE \`_works_v_version_populated_authors\`;`)
  await db.run(sql`DROP TABLE \`_works_v\`;`)
  await db.run(sql`DROP TABLE \`_works_v_rels\`;`)
  ...
  await db.run(sql`DROP TABLE \`side_nav_nav_items\`;`)
  await db.run(sql`DROP TABLE \`side_nav\`;`)
  await db.run(sql`DROP TABLE \`side_nav_rels\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_locked_documents_rels\`("id", "order", "parent_id", "path", "users_id", "media_id", "payload_folders_id") SELECT "id", "order", "parent_id", "path", "users_id", "media_id", "payload_folders_id" FROM \`payload_locked_documents_rels\`;`)
